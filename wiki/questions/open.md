...
`npm run sim` of dumb-vs-dumb on the bootstrap graph produces 100% draws at the tick limit. Trace shows the cause: both sides capture their adjacent neutrals quickly, then the front line oscillates because:
